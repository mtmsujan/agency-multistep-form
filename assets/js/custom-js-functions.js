...
(function ($) {
  $(document).ready(function () {
    ...
    const links = $(".imjol-form__nav a"); // Updated selector to target navigation links
    const progress = $(".progress-bar");
    const completionPercent = $(".imjol-form__quiz-banner-progress--percent");
    ...
    function showStep(stepIndex) {
      ...
      updateProgress();
      $(".test-form__quiz-current").addClass("zoom-out");
      setTimeout(function () {
        $(".test-form__quiz-current")
          .text(stepIndex + 1)
